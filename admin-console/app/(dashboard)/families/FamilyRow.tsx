  ...
  return (
    ...
    >
      <td className="px-4 py-3">
        <div className="flex items-center gap-3">
          {f.photo_url ? (
            ...
            <div className="w-8 h-8 rounded-full bg-[#C9A227]/15 flex items-center justify-center text-xs font-bold text-[#C9A227]">
          ...
          <div>
            ...
            {f.hoh_names && (
              <span className="block text-sm font-medium text-[#C9A227]">{f.hoh_names}</span>
            )}
          </div>
        </div>
      </td>
      ...
      <td className="px-4 py-3 text-right">
        <span className="text-[#C9A227] font-medium">Edit</span>
      </td>
    </tr>
  );
}
