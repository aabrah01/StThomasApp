      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            className="border border-gray-300 rounded-lg px-3 py-2 text-sm w-72 focus:outline-none focus:ring-2 focus:ring-[#7E282F]"
          />
          <Link
            href="/families/new"
            className="bg-[#7E282F] text-white text-sm font-semibold px-4 py-2 rounded-lg hover:bg-[#6B2228] transition-colors whitespace-nowrap"
          >
            + Add Family
          </Link>
        </div>
              ...
              <tr>
                <td colSpan={3} className="px-4 py-10 text-center text-gray-400">
                  {search
                    ...
                    : <>No families yet. <Link href="/families/new" className="text-[#7E282F] hover:underline">Add the first one.</Link></>}
                </td>
              </tr>
            )}
          </tbody>
